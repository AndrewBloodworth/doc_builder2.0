    ...
    settings: {
        ...
        line_matcher: (line) => {
            ...
            return {
                ...
                line_number: (!!matched && matched.length ? matched[1] : "") ||
                    (!!titles ? enums_1.StaticStyles.LINE_NUMBER_UNSET : ""),
            };
        },
        component_location: {},
        default_signatures: {},
        ...
        row_styles: {},
        segment_styles: {
            48: { address: [enums_1.SegmentStyles.BOLD__ALL] },
            49: { address: [enums_1.SegmentStyles.BOLD__ALL] },
        },
        static_settings: {
            [enums_1.StaticStyles.LINE_NUMBER_UNSET]: [enums_1.StaticStyles.KEEP__SINGLE],
        },
    },
};
